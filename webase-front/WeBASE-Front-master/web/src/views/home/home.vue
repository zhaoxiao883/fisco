...
<template>
    <div class="over-view-wrapper">
      ...
      <footer class="footer" style="color: gray;">
        <p style="text-align: center; font-weight: bold;">小Tips:</p>
        "FISCO-BCOS Browser" 是一个用于浏览和查询FISCO-BCOS区块链网络数据的工具<br>

        提供了以下主要功能：<br>

        <ol>
          <li>1、网络配置管理：可以通过Webase-Front管理多个区块链网络的节点信息、证书和私钥等配置。</li>

          <li>2、链上账户管理：可以在Webase-Front中管理和查看链上的账户信息，并进行账户的添加、删除、查询和导入等操作。</li>

          <li>3、合约管理：可以部署和管理智能合约，包括编译合约、发布合约、调用合约方法等。</li>

          <li>4、交易管理：可以查看和查询链上的交易记录，包括交易的哈希值、发送方、接收方、数值等信息。</li>

          <li>5、区块管理：可以查看和查询链上的区块信息，包括区块的高度、哈希值、交易数量、时间戳等。</li>

          <li>6、节点监控：可以实时监控和查看区块链网络中各个节点的状态，包括节点的连接状态、块高等。</li>
        </ol>
      </footer>
