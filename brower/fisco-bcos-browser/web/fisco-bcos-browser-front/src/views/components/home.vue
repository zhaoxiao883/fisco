        ...
        <div class="container">
          ...
          <footer class="footer" >
            <p style="text-align: center; font-weight: bold;">小Tips:</p>
              ...
              1. 区块查询：用户可以通过输入区块高度或区块哈希值来查看特定区块的详细信息，包括区块中的交易列表、时间戳、区块大小等。<br>
              2. 交易查询：用户可以通过输入交易哈希值或发送/接收地址来查询特定交易的详细信息，包括交易的发送者、接收者、交易状态等。<br>
              3. 合约查询：提供了查询和验证在 FISCO-BCOS 上部署的智能合约的工具和功能，用户可以查看合约的源代码、函数调用及执行结果。<br>
              4. 节点监控：允许用户监控 FISCO-BCOS 网络中的节点状态，包括节点的连通性、运行状态等。<br>
              5. 交易统计：提供了有关 FISCO-BCOS 网络的交易统计数据，如每秒交易数、区块产生时间等
          </footer>
