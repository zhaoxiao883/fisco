        ...
        <div class="nav-header">
            <div class="container">
                ...
                <div class="nav-menu">
                    ...
                    <div class="nav-menu-item nav-item" @click="routerLink('information')">版权信息</div>
                    <div class="nav-menu-item nav-item" @click="routerLink('test')">test</div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
      ...
      // 定义一个函数，接收一个参数，并使用Vue Router提供的push方法，跳转到name对应的路由界面
